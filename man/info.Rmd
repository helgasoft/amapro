...
- use a temporary Chinese phone number from sites like  
   [quackr.io](https://quackr.io/temporary-numbers/china), [sms24](https://sms24.me/en/countries/cn/), [turtle-sms](https://turtle-sms.xyz),  etc. However most are probably blacklisted as the registration page shows them as _already registered_.
...
- AMap's ecosystem is vast, some unsupported features include:
