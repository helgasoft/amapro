...
* [API](https://lbs.amap.com/api/javascript-api-v2/documentation) documentation, good auto-translation
...
- most **Loca** elements are supported, but not all have been tested. Latest _AmbientLight_, _DirectionalLight_ and _PointLight_ objects are not supported, but parameters _ambLight_, _dirLight_ and _pointLight_ accomplish the same.
...
- _am.init_ has a _debug_ (boolean) parameter, results are displayed in the browser Console
